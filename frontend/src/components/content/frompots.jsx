...
import Showlist1 from "./showlistdata1";
function Frompots({ sendDataToParent , value, checkcount,count ,payment}){
  ...
  const handletii = (data) => {
    ...
    return (
        ...
        <div className="bg-blue-300 grid grid-flow rounded-xl mx-3 shadow-2xl pb-2">
        <div className="flex justify-end mr-5 mt-4"><button onClick={check1}><FontAwesomeIcon icon={faXmark} size="2xl"/></button></div>
        ...
        <div>{handletii(data,dataCount)}</div>
  ...
  <table className="table">
    ...
    <Showlist1 data={value} payment={payment} value={databank} />
