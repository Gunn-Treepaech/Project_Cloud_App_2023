...
function Frompots2({ sendDataToParent , value,checkcount,count,payment}){
  ...
  const handletii = (data) => {
    ...
    return (
        ...
        <div className="bg-blue-300 grid grid-flow rounded-xl mx-3 pb-3">
        <div className="flex justify-end mr-5 mt-4"><button onClick={check2}><FontAwesomeIcon icon={faXmark} size="2xl"/></button></div>
