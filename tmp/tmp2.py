...
def calculate_loan_schedule(initial_loan, years_interest, total_payment, MRR, start_year, start_month):
    ...
    for month in range(start_month, start_month + 36):
        ...
        # print(f"Month {display_month}: current_year = {current_year:.2f}")
        # print(f"Month {display_month}: years_interest = {years_interest:.2f}")
        ...
        if remaining_principal <= 0:
            print("Loan fully repaid. Exiting calculation.")
            break
        ...
        remaining_principal = max(0, remaining_principal - balance)

        print(f"Month {display_month, current_year}: Remaining Principal = {remaining_principal:.2f}, Interest Paid = {interest_money:.2f}, Balance = {balance:.2f}")
...
start_year = 2024
# ------------------------------------------------------------------------------------------------
calculate_loan_schedule(initial_loan, years_interest, total_payment, MRR, start_year, start_month)