...
import Showlist3 from "./showlistdata3";
function Frompots3({ sendDataToParent , value ,checkcount,count,payment}){
  ...
  const handletii = (data) => {
    ...
    const check3 = (e) =>{
        setdataCount(count)
        console.log("999910",count);
        console.log("1000011",dataCount);
        e.preventDefault();
  ...
  <table className="table">
    ...
    <Showlist3 data={value} payment={payment} value={databank} />
